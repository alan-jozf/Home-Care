...
<style>
	...
	<script>
		...
		function myhname()
		{
			...
			if(n.value == "")
			{
				n.placeholder ="Hospital Name is empty";
			}
			else if(!n.value.match(letter))
			{
				n.value ="";
				n.placeholder ="Enter valid Hospital Name";
			}
		}
...
<body><b>
	...
	<form action="php\addMstaff.php" method="POST" >

    <div class="maindiv">
        <h1> <center>Register as a Medical Staff</center></h1>
        <div class="division">
        ...
        <div class="division">
            <input type="text" placeholder="Hospital Name :" name="hname"id="1"  onblur="myhname()"required>
