...
<style>
	...
	<script>
		...
		function myhname()
		{
			...
			if(n.value == "")
			{
				n.placeholder ="Punchayat name is empty";
			}
			else if(!n.value.match(letter))
			{
				n.value ="";
				n.placeholder ="Enter valid Punchayat Name";
			}
		}
...
<?php require("Topbar.php"); ?> 
	...
	<form action="php\addPunch.php" method="POST" >

    <div class="maindiv">
        <h1> <center>Register as a Punchayat Officer</center></h1>
        <div class="division1">
        ...
        <div class="division2">
            <input type="text" placeholder="Punchayat Name :" name="hname"id="1"  onblur="myhname()"required>
